...
FORCESUB_CHANNEL = int(os.environ.get("FORCESUB_CHANNEL", "-1002254684617"))
...
try:
    ADMINS=[]
    for x in (os.environ.get("ADMINS", "7531093827 5355745915 6911235730 5924136853 6802736263 5585016974").split()):
        ADMINS.append(int(x))
except ValueError:
